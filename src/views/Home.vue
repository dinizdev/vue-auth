...
<template>
    <div class="h-screen flex flex-col  gap-10 items-center justify-center text-white bg-zinc-900 sm:p-10">
        ...
        <form @submit.prevent="" class="flex flex-col gap-8 sm:w-auto">
            <input v-model="email" class="p-2 w-72 sm:w-96" type="text" placeholder="Email">
            <input class=" p-2 w-72 sm:w-96 " v-model="password" type="password" placeholder="Password">
            ...
            <router-link to="/register" class="text-center">
                <a class="text-green-300 pointer underline">Sign Up - Register Here</a>
            </router-link>
        </form>
